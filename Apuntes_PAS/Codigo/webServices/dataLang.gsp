...
<body>
	...
	<div class="body">
		...
		<h2>SERVEI WEB DE TRADUCCIÓ DE DIES DE LA SETMANA I MESOS DE L'ANY</h2>
					...
					<tbody>							
						<tr class="prop noBackground">
							<td valign="top" align="center" class="name">
							    <g:select class="width200px" name="filtreIdioma" from="${idiomasList}"  keys="${idiomasList}"  value="" noSelection="['':'-Tria un idioma-']"/>							   
							</td>
							...
							<td valign="top" align="center" class="name">
							    <g:select class="width200px" name="filtreDia" from="${diesList}"  keys="${1..8}"  value="" noSelection="['':'-Tria un dia de la setmana-']"/>							   
							</td>
							<td valign="top" align="center" class="name">
							    <g:select class="width200px" name="filtreMes" from="${mesosList}"  keys="${1..13}"  value="" noSelection="['':'-Tria un mes de l\'any-']"/>							   
							</td>
						</tr>							
	 				</tbody>
				</table>
