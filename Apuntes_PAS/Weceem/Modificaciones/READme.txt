...
weceem-1.2: plugin modificado para poder funcionar con Oracle. Se han tocado:
	WcmContent (Dominio) y todas las clases que heredan de él. Cambiando 'text' por 'materialized_clob'
...
Imágenes
--------
Modif_sec_1: muestra como queda el dominio y los controladores de la aplicación una vez se ha modificado la aplicación para funcionar con CAS UPC.