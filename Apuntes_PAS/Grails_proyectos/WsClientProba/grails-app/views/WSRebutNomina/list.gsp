			...
			<g:form action="visualitzarFitxer" method="POST">
				...
				<div>
					<div class="floatLeft padding cercaDates" style="height: 30px; vertical-align: text-top;">
						<label for="anyMes">Data &nbsp;</label><g:select name="anyMes" id="anyMes" keys="${['201407','201408','201409']}" from="${['201407','201408','201409']}" value="${params.anyMes}"/>														
