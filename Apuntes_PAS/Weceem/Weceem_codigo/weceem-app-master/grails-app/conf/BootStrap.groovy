...
//            }
//			if (!CMSRole.findByAuthority('ROLE_GUEST')) {
//				assert new CMSRole(authority: 'ROLE_GUEST', description: 'Guest role').save(flush:true)
//			}
//
...
//						.addToAuthorities(CMSRole.findWhere(authority: 'ROLE_GUEST'))
//                        .save(flush:true)
//            } 
